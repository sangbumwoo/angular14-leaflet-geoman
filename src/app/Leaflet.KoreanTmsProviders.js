(function (root, factory) {
	...
	// http://demo.cmworld.net:18080/cmworld2d/sample/maps/baroEmap;jsessionid=EB9F45C12FED86F3FB597ABF4C45A6F6 참고
	L.Proj.CRS.UTMKCRS = (function() {
		var E3l = [];
		var F3l = 66846.720000000001;
		for (var D3l = 0; D3l < 25; D3l++) {
		  E3l.push(1.0 / F3l * Math.pow(2, D3l));
		}
		var C3l = new L.Proj.CRS('ESPG:5179','+proj=tmerc +lat_0=38 +lon_0=127.5 +k=0.9996 +x_0=1000000 +y_0=2000000 +ellps=GRS80 +units=m +no_defs ',{
		  scales: E3l,
		  origin: [-200000, 4000000],
		  tms: false
		});
		C3l.projection.bounds = new L.bounds(new L.point(-200000,-13112760.32),new L.point(15112760.32,4000000));
		C3l.distance = L.CRS.Earth.distance;
		C3l.R = 6378137;
		return C3l;
	})();
